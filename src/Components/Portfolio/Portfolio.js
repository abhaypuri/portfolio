...
class PortfolioCard extends Component {
  ...
  handleLinks(linkData) {
    ...
    if (count > 0) {
      for (let i = 0; i < links.length; i++) {
        ...
        if (content === "Arxiv") iconClass = "fas fa-file-pdf";
        else if (content === "Demo") iconClass = "fab fa-youtube";
        else if (content === "Medium") iconClass = "fab fa-medium";
        else if (content === "GitHub") iconClass = "fab fa-github";
        else iconClass = "fas fa-globe-americas";

        htmlLinks.push(
          <span>
            <a href={links[i].trim()} target="_blank" rel="noopener noreferrer">
              <i
  ...
  handleImgSrc() {
    ...
    else src = process.env.PUBLIC_URL + this.props.element.src;
    return src;
  }
  ...
  render() {
    ...
    // for links as well.
    let linkStyle =
      this.props.width > 850 ? "link-style-lg " : "link-style-sm ";
    ...
    return (
      <div
        style={cardStyle}
        className={
          this.props.filter[this.props.element.tag]
      ...
      >
        ...
        />
        <h3
          style={{ paddingLeft: "3px", fontFamily: "Aleo", fontWeight: "700" }}
        >
...
class Portfolio extends Component {
  ...
  calculateLeftPad() {
    ...
    if (this.props.width <= this.doubleCardSmall)
      ...
      leftPad = Math.floor(
        (this.props.width - this.singleUnitWidthSmall * 2) / 2
      );
    else if (
      this.props.width > this.tripleCardSmall &&
      ...
      leftPad = Math.floor(
        (this.props.width - this.singleUnitWidthSmall * 3) / 2
      );
    else if (
      this.props.width > this.quadCardSmall &&
      ...
      leftPad = Math.floor(
        (this.props.width - this.singleUnitWidthSmall * 4) / 2
      );
    else if (
      this.props.width > this.pentaCardSmall &&
      ...
      leftPad = Math.floor(
        (this.props.width - this.singleUnitWidthLarge * 2) / 2
      );
    else if (
      this.props.width > this.tripleCardLarge &&
      ...
      leftPad = Math.floor(
        (this.props.width - this.singleUnitWidthLarge * 3) / 2
      );
    else if (this.props.width > this.quadCardLarge)
      leftPad = Math.floor(
        (this.props.width - this.singleUnitWidthLarge * 4) / 2
      );
      ...
      <div className="portfolio-style">
        <div className="filter-button-style">
          <button
            ...
            onClick={() => this.toggleClass("talk")}
          >
            Talks
          </button>
          <button
            className="btn btn-danger"
            onClick={() => this.toggleClass("project")}
          >
            Projects
          </button>
        </div>
